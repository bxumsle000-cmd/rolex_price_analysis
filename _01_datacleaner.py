...
if __name__ == "__main__":
    ...
    cleaner.load_data()  # 載入資料
    cleaner.clean_year_of_production()  # 清除不合理年分，以及計算錶齡
    cleaner.clean_case_diameter() # 清除不合理尺寸
    cleaner.group_case_material(threshold=0.01)  # 設定材質分群
    cleaner.process_scope_of_delivery() # 處理配件資訊 (has_box, has_papers, full_set)
    cleaner.group_location(threshold=0.01) # 區域轉換為國家，並將少數國家合為"Other""
